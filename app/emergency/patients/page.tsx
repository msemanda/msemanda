...
const patients = [
    { id: "E001", name: "Unknown Male", age: 45, complaint: "Chest pain — possible MI", arrived: "09:05", doctor: "Dr. Bwire", nurse: "Nurse Atim", disposition: "ADMITTED — CCU", status: "IN_TREATMENT", triage: "IMMEDIATE" },
    { id: "E002", name: "Grace Nakabuye", age: 28, complaint: "RTA — head injury", arrived: "09:20", doctor: "Dr. Bwire", nurse: "Nurse Ssali", disposition: "CT scan ordered — neurosurgery consult", status: "IN_TREATMENT", triage: "IMMEDIATE" },
    ...
    { id: "E005", name: "Joshua Byaruhanga", age: 8, complaint: "Febrile convulsion", arrived: "10:15", doctor: "Dr. Katongo", nurse: "Nurse Atim", disposition: "Stabilised — pediatric admission likely", status: "IN_TREATMENT", triage: "URGENT" },
    ...
    { id: "E007", name: "John Mwebe", age: 30, complaint: "Hand laceration", arrived: "10:50", doctor: "Dr. Namubiru", nurse: "Nurse Ssali", disposition: "Minor surgery — sutures", status: "IN_TREATMENT", triage: "NON_URGENT" },
];
                    ...
                    <tbody className="divide-y divide-gray-50">
                        {filtered.map((p, i) => (
                            <motion.tr key={p.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.04 }} className="hover:bg-gray-50/50">
                                ...
                                <td className="px-4 py-3 text-[10px] text-gray-500">{p.doctor || "—"}<br />{p.nurse || ""}</td>
