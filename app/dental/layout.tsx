...
import { LayoutDashboard, Users, CalendarDays, ClipboardList, Scan } from "lucide-react";

const sidebarGroups: SidebarGroup[] = [
    { label: "Overview", items: [{ name: "Dashboard", href: "/dental/dashboard", icon: LayoutDashboard }] },
    {
        label: "Clinical",
        items: [
            { name: "Patients", href: "/dental/patients", icon: Users },
            { name: "Appointments", href: "/dental/appointments", icon: CalendarDays },
            { name: "Dental Chart", href: "/dental/chart", icon: ClipboardList },
            { name: "X-Rays", href: "/dental/xrays", icon: Scan },
        ],
    },
];
...
export default function DentalLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex h-screen bg-gray-50 overflow-hidden">
            <RoleSidebar groups={sidebarGroups} roleLabel="Dental" />
