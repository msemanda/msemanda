...
/**
 * Real appointment booking used by both Reception and Admin — same
 * consultation-fee gate, patient dedup guard and notifications either way,
 * so the two entry points can never drift out of sync with each other.
 */
export function BookAppointmentForm({
    title = "Book Appointment",
    subtitle = "Schedule a doctor consultation for a patient",
