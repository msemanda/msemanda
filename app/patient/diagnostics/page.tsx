...
export default function PatientDiagnosticsPage() {
    ...
    const handleExportAll = () => {
        ...
        a.href = url;
        a.download = `diagnostic-reports-${profile?.uid?.substring(0, 8) || "export"}.json`;
        a.click();
    ...
    return (
        <div className="max-w-5xl mx-auto py-12 px-4">
            ...
            <div className="flex justify-between items-end mb-10">
                ...
                <Button variant="outline" className="flex items-center border-gray-200" onClick={handleExportAll} disabled={reports.length === 0}>
                            ...
                            <div className="p-8">
                                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-900">Diagnosis Report</h3>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="bg-gray-50 p-4 rounded-xl border flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600">{report.dosage}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="mt-8 pt-6 border-t flex flex-col md:flex-row md:items-center justify-between text-sm text-gray-500 gap-4">
                                    <p><strong>Pharmacy ID:</strong> {report.pharmacyId}</p>
