...
import { LayoutDashboard, Users, UtensilsCrossed, ClipboardList, Apple } from "lucide-react";

const sidebarGroups: SidebarGroup[] = [
    { label: "Overview", items: [{ name: "Dashboard", href: "/dietary/dashboard", icon: LayoutDashboard }] },
    {
        label: "Nutrition",
        items: [
            { name: "Diet Plans", href: "/dietary/plans", icon: UtensilsCrossed },
            { name: "Patients", href: "/dietary/patients", icon: Users },
            { name: "Food Menu", href: "/dietary/menu", icon: Apple },
            { name: "Assessments", href: "/dietary/assessments", icon: ClipboardList },
        ],
    },
];
...
export default function DietaryLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex h-screen bg-gray-50 overflow-hidden">
            <RoleSidebar groups={sidebarGroups} roleLabel="Dietary" />
